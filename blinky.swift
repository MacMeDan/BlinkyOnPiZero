...
//  BlinkyOnPIZero
//
//  Created by Dan Leonard on 2/11/16.
//  Copyright © 2016 macme. All rights reserved.
//
...
//Sorry the code looks so bad but 4 loops were not working
//this runs on ARMv6 on a #PiZero makes pin 2 blink on and off

let gpios = SwiftyGPIO.getGPIOsForBoard(.RaspberryPiPlus2Zero)
print("\n")
print("Setup Pin 2 for Blinkification")
sleep(1)
print("\n")
let gp = gpios[.P2]!
gp.direction = .OUT
print("Blink it up Like a boss you beautiful Swift you!")
gp.value = 1
sleep(1)
gp.value = 0
sleep(1)
...
gp.value = 0
print("\n")
print("Blinking Complete Thanks Swift")
print("\n")
print("                    -@MacMeDan")
print("\n")